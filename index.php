		...
		<div class="container">
			<div class="row align-items-center justify-content-between">
				<div class="col-lg-6 col-md-6 home-about-left">
					<img class="img-fluid" src="<?php echo get_template_directory_uri() ?>/img/about-img.png" alt="">
				</div>
                    ...
                    <div class="single-portfolio col-sm-4 all vector">
                    	<div class="relative">
							...
							<a href="<?php echo get_template_directory_uri() ?>/img/p1.jpg" class="img-pop-up">	
							  <div class="middle">
							    <div class="text align-self-center d-flex"><img src="<?php echo get_template_directory_uri() ?>/img/preview.png" alt=""></div>
							  </div>
						</a>                              		
                    	</div>
						<div class="p-inner">
            ...
            <div class="row">
                <div class="active-testimonial">
                    <div class="single-testimonial item d-flex flex-row">
                        <div class="thumb">
                            <img class="img-fluid" src="<?php echo get_template_directory_uri() ?>/img/elements/user1.png" alt="">
                        </div>
                        <div class="desc">
                            <p>
                    ...
                    <div class="single-testimonial item d-flex flex-row">
                        <div class="thumb">
                            <img class="img-fluid" src="<?php echo get_template_directory_uri() ?>/img/elements/user2.png" alt="">
                        </div>
                        <div class="desc">
                            <p>
		...
		<div class="container">
			...
			<div class="row">	
				<div class="single-recent-blog col-lg-4 col-md-4">
					<div class="thumb">
						<img class="f-img img-fluid mx-auto" src="<?php echo get_template_directory_uri() ?>/img/b1.jpg" alt="">	
					</div>
					<div class="bottom d-flex justify-content-between align-items-center flex-wrap">
						<div>
							<img class="img-fluid" src="<?php echo get_template_directory_uri() ?>/img/user.png" alt="">
				...
				<div class="single-recent-blog col-lg-4 col-md-4">
					<div class="thumb">
						<img class="f-img img-fluid mx-auto" src="<?php echo get_template_directory_uri() ?>/img/b2.jpg" alt="">	
					</div>
					<div class="bottom d-flex justify-content-between align-items-center flex-wrap">
						<div>
							<img class="img-fluid" src="<?php echo get_template_directory_uri() ?>/img/user.png" alt="">
				...
				<div class="single-recent-blog col-lg-4 col-md-4">
					<div class="thumb">
						<img class="f-img img-fluid mx-auto" src="<?php echo get_template_directory_uri() ?>/img/b3.jpg" alt="">	
					</div>
					<div class="bottom d-flex justify-content-between align-items-center flex-wrap">
						<div>
							<img class="img-fluid" src="<?php echo get_template_directory_uri() ?>/img/user.png" alt="">
